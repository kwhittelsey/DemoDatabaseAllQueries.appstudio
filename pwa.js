...
const cacheName = 'DatabaseSamples-2020-03-18 10:54:41.672582'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'DatabaseSamples'.length) === 'DatabaseSamples') {
